/** Display toggles for contact-list chrome (badges + initials). */
...
export const DEFAULT_SHOW_MESSAGE_BADGE: BadgeVisibility = "on";
export const DEFAULT_SHOW_GROUP_MESSAGE_BADGE: BadgeVisibility = "on";
