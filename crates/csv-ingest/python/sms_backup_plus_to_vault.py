#!/usr/bin/env python3
"""Convert sms-backup-plus-exporter-csv output to vault NDJSON.
...
Usage:
  python3 sms_backup_plus_to_vault.py --input path/to.csv --output /tmp/out
"""
